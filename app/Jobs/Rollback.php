...
namespace App\Jobs;
use App\Events\ProjectRollbacked;
use App\Events\ProjectRollbackFailed;
use Symfony\Component\Process\Process;
use Symfony\Component\Process\Exception\ProcessFailedException;
use App\Models\Project;

class Rollback extends Job
{
    protected $project;
    protected $user;
    ...
    public function handle()
    {
        ...
        if (!file_exists($deployConfigFile)) {
            event(new ProjectRollbackFailed($this->project, $this->user), 'Deploy configuration file not exists');
            return false;
        }

        $deployerTask = 'rollback';
        ...
        try {
            ...
            event(new ProjectRollbackFailed($this->project, $this->user), $exception->getMessage());
            return false;
        }

        event(new ProjectRollbacked($this->project, $this->user));
    }
}
